...
CREATE INDEX treatment_invoice_id ON treatments_medical_histories(treatment_id)
CREATE INDEX medical_history_id ON treatments_medical_histories(medical_history_id)
